...
Created: 2026-05-09T18:53:07
Score: 55/100
Verdict: Needs producer review before final render

## Fix First
- [WARN] Narrative / Has emotional peak: Strengthen chorus/final chorus scene role
...
- [WARN] Narrative / Has setup and ending: Add clear opening and resolution scenes
- [WARN] Render / Audio source: Add audio file in Render Lab

## Checks
- OK Narrative / Storyboard exists: 1 scenes found
- WARN Narrative / Has setup and ending: roles: setup
- WARN Narrative / Has emotional peak: peak scene: 1
- OK Narrative / Visual story consistency: score 93
- OK Character / Character profile: character lock metadata present
- WARN Character / Prompt character consistency: average score 50.0
...
- OK Subtitle / Dynamic subtitle emotion: 1 scenes have emotion style
- OK Hook / Hook candidate: top hook score 94
- OK Hook / Hook clip readiness: 1 TikTok candidates
...
- OK Assets / Missing asset check: missing scenes: none
