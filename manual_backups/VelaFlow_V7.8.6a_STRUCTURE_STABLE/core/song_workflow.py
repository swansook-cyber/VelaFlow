...
def save_song_state(project_name: str, song: Dict[str, Any], base_dir: str | Path | None = None, create_draft: bool = False) -> Dict[str, Any]:
    try:
        ...
        suno_export = export_suno_files(project_name, normalized, base_dir)
        draft_path = ""
        if create_draft:
