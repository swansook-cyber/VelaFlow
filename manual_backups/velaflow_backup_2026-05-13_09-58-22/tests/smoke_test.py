...
from core.seller_content import export_seller_content, generate_seller_content, seller_content_to_text
...
def main():
    ...
    for section in ["TIKTOK HOOKS", "SHORT VIDEO SCRIPT", "CTA SUGGESTIONS", "CAPTION", "HASHTAGS", "AI VIDEO PROMPT", "B-ROLL SHOT IDEAS"]:
