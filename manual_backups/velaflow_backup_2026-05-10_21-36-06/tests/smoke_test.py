...
from core.navigation_config import FULL_MENU_GROUPS, PAGE_LABELS, SONG_ONLY_ALLOWED_PAGES, SONG_ONLY_MENU_GROUPS, flatten_pages
...
def main():
    ...
    assert_true(APP_VERSION == "7.8.5" and identity_payload()["generated_by"] == "VelaFlow", "version identity failed")
