...
st.caption(f"{PRODUCT_TAGLINE} by {BRAND_NAME} | V7.8.5 Navigation & Layout Organization Pass")
...
if page == "Dashboard":
    ...
    _page_header("Creator Wizard", "Start from a template and prepare the project workflow.", project)
