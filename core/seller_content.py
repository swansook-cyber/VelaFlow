...
def export_seller_content(
    ...
    try:
        project_dir = Path(base_dir) / safe_name(project_name or package.get("product_name") or "seller_project") if base_dir else resolve_project_folder(project_name or package.get("product_name") or "seller_project", "seller")
