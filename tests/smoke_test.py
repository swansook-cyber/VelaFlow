...
def main():
    ...
    assert_true("@media (max-width: 768px)" in css and "min-height: 2.75rem" in css and "padding-top: max(4rem" in css and "padding-left: 0.9rem" in css and "gap: 0.3rem" in css and "st-key-velaflow_local_api_read" in css, "compact mobile UI styles failed")
...
"""
        ...
        assert_true('st.markdown("### VelaFlow")' in sidebar_source and "AI Music Production" in sidebar_source and 'st.radio(' in sidebar_source and 'key="selected_page"' in sidebar_source and "st.image" not in sidebar_source, "sidebar branding/navigation should be compact and text-only")
        ...
        assert_true("_render_music_pipeline_status" not in active_editor_slice and "Cut or join MP3/WAV files with simple local tools." not in active_editor_slice, "Audio Editor default UI still contains pipeline or instructional clutter")
