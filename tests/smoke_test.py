...
"""
        ...
        settings_controls_source = main_source[main_source.find("def _render_settings_system_controls"):main_source.find("def _render_agent_workspace_panel")]
        ...
        assert_true(all(text in settings_controls_source for text in ["Project Management", "Advanced / Developer Mode", "Workflow Mode", "Closed Beta & Founding Member", "License & Build", "System & Provider Status"]), "moved admin/system controls missing from Settings")
