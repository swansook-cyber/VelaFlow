...
def main():
    ...
    assert_true(SIMPLE_NAVIGATION_PAGES == ["Home", "Song Studio", "Remaster Studio", "Audio Editor", "Visual Studio", "Release Pack", "Settings"] and len(SIMPLE_NAVIGATION_PAGES) == len(set(SIMPLE_NAVIGATION_PAGES)), "simple navigation order or uniqueness failed")
...
"""
        ...
        assert_true("vf-sidebar-brand" in sidebar_source and "AI Music Production" in sidebar_source and 'st.radio(' in sidebar_source and sidebar_source.count('"Navigation"') == 1 and 'format_func=_premium_navigation_label' in sidebar_source and 'key="selected_page"' in sidebar_source and "st.image" not in sidebar_source, "sidebar branding/navigation should be compact, app-like, and contain one Navigation heading")
        ...
        assert_true("VelaFlow Agent Studio" not in SIMPLE_NAVIGATION_PAGES and "Audio Editor" in SIMPLE_NAVIGATION_PAGES and "Settings" in SIMPLE_NAVIGATION_PAGES, "advanced destinations leaked into compact navigation")
