...
def main():
    ...
    assert_true(all(token in css for token in ["--vf-primary: #4257e8", "--vf-radius-card: 16px", ".vf-home-header", ".vf-welcome-card", ".vf-page-header", ".vf-tool-icon", ".st-key-vf_home_tools", ".st-key-vf_song_form"]), "premium mobile design system is incomplete")
...
"""
        ...
        assert_true('st.container(border=True, key="vf_song_form")' in simple_song_source and 'song_form.button("Generate Lyrics"' in simple_song_source and 'song_form.expander("Advanced", expanded=False)' in simple_song_source, "Song Studio creation panel or primary CTA styling hook missing")
