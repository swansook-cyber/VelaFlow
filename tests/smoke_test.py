...
"""
        ...
        assert_true("AI Creative Pack Generator" in main_source and "Generate Song" in main_source and "Generate Final Song" in main_source and "No Render" in main_source and "Advanced Song Studio for quality-first lyrics, hooks, producer prompts, and release packs. Render outside with your favorite tools." in main_source and "Story Type" in main_source and "Hook Style" in main_source, "creative pack generator UI missing")
        assert_true("Title + Hook Preview" in main_source and "Advanced Assets (optional)" in main_source and "Copy A into Suno Lyrics" in main_source and "Copy B into Suno Style of Music" in main_source, "creative pack workflow reorder missing")
        assert_true("Recommended AI Controls" in main_source and "Reset to Recommended" in main_source and "Advanced Creative Controls" in main_source and "Manual Override Active" in main_source, "creative pack AI control cleanup missing")
        assert_true("Generate Song Seeds" not in main_source and "Generate Full Lyrics from Selected Seed" not in main_source, "old duplicate song generation actions still visible")
