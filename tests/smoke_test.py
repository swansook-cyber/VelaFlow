...
"""
        ...
        assert_true("AI Creative Pack Generator" in main_source and "Generate Candidates" in main_source and "Generate Final Release Pack" in main_source and "No Render" in main_source and "Advanced Song Studio for quality-first lyrics, hooks, producer prompts, and release packs. Render outside with your favorite tools." in main_source and "Story Type" in main_source and "Hook Style" in main_source, "creative pack generator UI missing")
        assert_true("Song Idea → Generate Candidates → Select Story/Hook/Title → Generate Final Release Pack" in main_source and "Selected Seed" in main_source and "View all candidate details" in main_source, "creative pack single-path workflow missing")
        assert_true("AI Quality Mode: Auto Optimized" in main_source and "Reset to Recommended" in main_source and "Advanced Creative Controls" in main_source and "Manual Override Active" in main_source, "creative pack AI control cleanup missing")
