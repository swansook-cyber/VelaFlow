...
"""
        ...
        assert_true("def render_agent_studio(" in main_source and 'elif page == "VelaFlow Agent Studio":' in main_source and "render_agent_studio(project)" in main_source and "Agent Studio failed to initialize" in main_source, "Agent Studio render route/fallback missing")
