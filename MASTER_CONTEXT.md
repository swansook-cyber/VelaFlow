...
New public-beta project folders are workflow-specific: `project_data/music`,
`project_data/seller`, `project_data/podcast`, `project_data/clips`, and
`project_data/mv`. Legacy `project_data/projects` folders remain readable as
fallback.
