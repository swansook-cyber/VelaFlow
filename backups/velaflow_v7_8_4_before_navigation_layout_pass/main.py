...
def _render_artist_preset_manager() -> None:
    st.subheader("Artist Preset Manager")
    st.caption("Local/offline artist preset management. Vela Moon is locked as the system preset.")
...
st.caption(f"{PRODUCT_TAGLINE} by {BRAND_NAME} | V7.8.4 Artist Preset Manager")
...
FULL_MENU_GROUPS = {
    ...
    "System": ["System Health", "Release Hardening Tools", "AI Settings", "Artist Preset Manager"],
}
SONG_ONLY_MENU_GROUPS = {
    "Start": ["Dashboard", "Song Studio", "Song Library", "AI Settings", "Artist Preset Manager"],
}
...
with st.sidebar:
    ...
    if selected_mode != st.session_state.get("workflow_mode"):
        ...
        if selected_mode == "Song Studio Only" and st.session_state.selected_page not in {"Dashboard", "Song Studio", "Song Library", "AI Settings", "Artist Preset Manager"}:
